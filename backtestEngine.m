                ...
                for btIdx = 1:numTimeSteps
                    ...
                    if (pricesTT.Time(btIdx) ==  NextRebalanceDate)
                        ...
                        if 0 <= endTimeIdx - strategies(i).LookbackWindow(1)
                            ...
                            if sum(eodPositionsUpdated((1:end~=cash_idx)&(eodPositionsUpdated<0)))~=0
                                disp(eodPositionsUpdated((1:end~=cash_idx)&(eodPositionsUpdated<0)))
                            end
                            ...
                            % Delta Cash Flow
                            deltaCashFlow = deltaCashFlow + eodPositionsUpdated- eodPositions;
                    ...
                    eodPositions = eodPositions .* retn;
                    eodPortValue = sum(eodPositions);
